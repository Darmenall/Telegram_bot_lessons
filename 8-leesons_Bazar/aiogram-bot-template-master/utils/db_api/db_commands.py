...
class Database:
    ...
    ### Zatlar ushin tablica (table) jaratamiz
    async def create_table_products(self):
        ...
        -- Zatlar kategoriyasi
        category_code VARCHAR(20) NOT NULL,  -- category codi menen isleymis
        category_name VARCHAR(50) NOT NULL,  -- Paydalaniwshig'a koriniwshi zategoriya ati

        -- Zatlar kategoriya ishinde ketgoriyasi ("Go'sh"->"Mal go'shi")
        subcategory_code VARCHAR(20) NOT NULL,
        subcategory_name VARCHAR(50) NOT NULL,

        -- Zatlarlar haqinda magliwmat
    ...
    async def get_categories(self):  # tablicadagi hamme categoriyalar koriw
