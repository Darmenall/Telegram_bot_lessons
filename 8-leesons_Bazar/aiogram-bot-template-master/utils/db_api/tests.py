...
async def test():
    ...
    print("Users tablicasin jaratamiz...")
    await db.drop_users()
    await db.create_table_users()
    print("Jaratildi")
    print("Paydalaniwshilardi qosamiz")
    await db.add_user("Darmen", "Allambergenov", 123456789)
    ...
    print(f"paydalaniwshi: {user}")

    ### Zatlar ushin test
    print("Products Products tablicasin jaratamiz...")
